...
(103, 'Laylo', 1),
(104, 'Sami', 3),
(105, 'Aziz', NULL); -- Aziz hech kursga yozilmagan
...
(1001, 1, 101),   -- Ali laptop oldi
(1002, 2, 102),   -- Vali telefon oldi
(1003, 3, 103),   -- Gulbahor printer oldi
(1004, 1, 102);   -- Ali yana telefon oldi
...
where c.CategoryName LIKE '%electronics%' 
    or c.CategoryName like '%furniture%'
