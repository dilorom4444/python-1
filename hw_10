...
------------------------------------------------------------
-- ✅ 1. Employees earning > 50000 with their department name
------------------------------------------------------------
SELECT 
...
------------------------------------------------------------
-- ✅ 2. Customers and order dates for orders placed in 2023
------------------------------------------------------------
SELECT 
    c.FirstName,
    c.LastName,
...
------------------------------------------------------------
-- ✅ 3. All employees with department names (include those with no department)
------------------------------------------------------------
SELECT 
    e.Name AS EmployeeName,
    d.DepartmentName
...
------------------------------------------------------------
-- ✅ 5. All orders and their payments (include unmatched ones)
------------------------------------------------------------
SELECT 
    o.OrderID,
    o.OrderDate,
...
------------------------------------------------------------
-- ✅ 6. Each employee and their manager name
------------------------------------------------------------
SELECT 
    e.Name AS EmployeeName,
...
------------------------------------------------------------
-- ✅ 8. Customers who placed orders with quantity > 3
------------------------------------------------------------
SELECT 
    c.FirstName,
    c.LastName,
...
------------------------------------------------------------
-- ✅ 10. Departments that have more than 5 employees
------------------------------------------------------------
SELECT 
    d.DepartmentName,
...
------------------------------------------------------------
-- ✅ 13. Only records where both employee and department exist
------------------------------------------------------------
SELECT 
    e.Name AS EmployeeName,
    d.DepartmentName
...
------------------------------------------------------------
-- ✅ 14. Employee pairs who report to the same manager
------------------------------------------------------------
SELECT 
...
------------------------------------------------------------
-- ✅ 15. All orders placed in 2022 with customer names
------------------------------------------------------------
SELECT 
    o.OrderID,
    o.OrderDate,
...
------------------------------------------------------------
-- ✅ 16. Employees from 'Sales' department with salary > 60000
------------------------------------------------------------
SELECT 
    e.Name AS EmployeeName,
    e.Salary,
...
select
	...
	p.productname
from Categories c
right join Products p on p.Category=c.CategoryID
