...
SELECT 
    year,
    [Bektemir] AS Bektemir_Pop,
    [Chilonzor] AS Chilonzor_Pop,
    [Yakkasaroy] AS Yakkasaroy_Pop
...
SELECT 
    district_name,
    '2012' AS year,
    Pop_2012 AS population
FROM Population_Each_Year
WHERE Pop_2012 IS NOT NULL
...
SELECT 
    district_name,
    '2013' AS year,
    Pop_2013 AS population
FROM Population_Each_Year
WHERE Pop_2013 IS NOT NULL;
--21
select
    p.productname,
...
SELECT 
    ...
    year,
    Bektemir_Pop AS population
FROM Population_Each_City
WHERE Bektemir_Pop IS NOT NULL
...
SELECT 
    ...
    year,
    Chilonzor_Pop AS population
FROM Population_Each_City
WHERE Chilonzor_Pop IS NOT NULL
...
SELECT 
    ...
    year,
    Yakkasaroy_Pop AS population
FROM Population_Each_City
WHERE Yakkasaroy_Pop IS NOT NULL;
